...
class SensorSimulator:
    def __init__(self, sensor_type, broker, port, topic_base, sensor_id, agent_monitor_id, 
                     username, password, interval=5, user_object = None):
...
class TemperatureSensor(SensorSimulator):
    def __init__(self, type, broker, port, topic_base, sensor_id, agent_id, mqtt_username, mqtt_password, interval=5):
        super().__init__(type, broker, port, topic_base, sensor_id, agent_id, mqtt_username, mqtt_password, int(interval))
...
class PresenceSensor(SensorSimulator):
    def __init__(self, type, broker, port, topic_base, sensor_id, agent_id, mqtt_username, mqtt_password, interval=5, defaultUser=None):
        super().__init__(type, broker, port, topic_base, sensor_id, agent_id, mqtt_username, mqtt_password, int(interval), defaultUser)
        self.value = 0
...
def main():
    ...
    temperature_sensor = TemperatureSensor(broker, port, topic_base, 'sensor_0', 'AGENTX')
